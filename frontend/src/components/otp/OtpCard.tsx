...
function OtpCard() {
    ...
    <>
        <div className={`2xl:w-[385px] w-8/12 relative`}>
            <div className={`${isVerifying ? 'blur-sm' : ''} ${styles.playCard}  overflow-hidden h-[522px] w-full  max-w-[900px] 2xl:w-[385px] bg-color-0 rounded-[22px] flex flex-col items-center justify-center gap-[22px]`}>
                ...
                <div className='w-[200px] h-[200px] bg-color-26 rounded-[10px] relative object-cover flex items-center justify-center border-[0.5px] border-color-6'>
                ...
                <div className='flex items-center justify-center w-[200px] h-[30px] bg-color-26 rounded-[10px]'>
                    <input
                        ...
                        maxLength={6}
                        className='placeholder-color-6  h-full tracking-[18px] placeholder:font-light  placeholder:text-[12px] placeholder:tracking-[4px] placeholder:text-start  font-poppins font-medium rounded-[10px] text-color-6 text-[22px] w-full ml-[18px] placeholder:mb-1 bg-color-26 focus:outline-none'
                ...
                <div className=" flex w-full items-center justify-center gap-[10px] md:gap-[36px] md:flex-row flex-col ">
                    <div onClick={handleVerifyClick} className="w-[141px] h-[35px] bg-color-6 rounded-[22px] flex items-center justify-center cursor-pointer">
                        <p className="text-[14px] text-color-0 font-nico-moji" >Verify Code</p>
                    </div>
                </div>

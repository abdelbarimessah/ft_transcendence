...
function ChannelConversation(){
    ...
    if (UserData.whatIcon == "channel")
    {
        return (
            <>
                <div className='flex  justify-between items-center  px-3 min-h-[60px] bg-[#FEE7C5] cursor-pointer hover:bg-[#635b4d]' onClick={handelAddNewConversation}>

                    <h1 className=' text-color-2 text-lg' >  Add New Channel </h1>
                    <Btns icon={"../../assets/addChannel.png"} onClick={() => {handelAddNewConversation}}/>

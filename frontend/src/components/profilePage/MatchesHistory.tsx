        ...
        <div className=" h-[619px] w-[596px] bg-color-0 rounded-[22px] flex flex-col gap-[34px]">
            <div className="w-full flex items-center justify-center gap-[15px] pt-[18px]">
                ...
                <div className='flex gap-[10px] '>
                    <span className='font-nico-moji text-color-6 text-[32px] '>Matches</span>
                    <span className='font-nico-moji text-color-29 text-[32px] '>History</span>
                </div>
            </div>
            <div className="w-full flex flex-col gap-[25px] ">
                <div className="w-full h-[58px] flex gap-[8px] cursor-pointer items-center justify-center ">
                    <div className="flex h-full w-[224px] rounded-[209px]  gap-[10px] items-center justify-start bg-color-30">

    ...
    const getAchievements = async () => {
      try {
        ...
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL}/user/achievements`,
          { withCredentials: true }
        );
        setAch1(
          res.data.achievements.find(
            (ach: { name: string }) => ach.name === "ach1"
          )
        );
        setAch2(
          res.data.achievements.find(
            (ach: { name: string }) => ach.name === "ach2"
          )
        );
        setAch3(
          res.data.achievements.find(
            (ach: { name: string }) => ach.name === "ach3"
          )
        );
        setAch4(
          res.data.achievements.find(
            (ach: { name: string }) => ach.name === "ach4"
          )
        );
        setAch5(
          res.data.achievements.find(
            (ach: { name: string }) => ach.name === "ach5"
          )
        );
        setAch6(
          res.data.achievements.find(
            (ach: { name: string }) => ach.name === "ach6"
          )
        );
        setAch7(
          res.data.achievements.find(
            (ach: { name: string }) => ach.name === "ach7"
          )
        );
        setIsLoading(false);
      } catch (err) {
        ...
        <div className="groupache flex flex-col gap-[20px] relative ">
          <div className="w-full flex gap-[50px]  justify-center">
                ...
                <div className="relative w-[58px] h-[58px] overflow-hidden">
                  {ach5?.locked ? (
                    <Image
                      ...
                      className="object-cover w-full h-full"
                      draggable={false}
                      title="Road Runner: You can lock this by wining in 20 game in the friends mode."
                    />
                  ) : (
                    <Image
            ...
            <div className="relative w-[97px] h-[125px] overflow-hidden   hover:scale-110 ">
              <Image
                ...
                draggable={false}
                title="Unstoppable: You can lock this by wining in 20 game in the random mode."
              />
              <div className="w-[58px] h-[58px] absolute z-[1000]  top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="relative w-[58px] h-[58px] overflow-hidden">
                  {ach6?.locked ? (
            ...
            <div className="relative w-[97px] h-[125px] overflow-hidden   mt-[73px]  hover:scale-110">
              <Image
                ...
                draggable={false}
                title="Warrior: You can lock this by wining in 1game in the friends mode."
              />
              <div className="w-[58px] h-[58px] absolute z-[1000]  top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="relative w-[58px] h-[58px] overflow-hidden">
                  {ach1?.locked ? (
          ...
          <div className=" w-[97px] h-[125px] overflow-hidden   absolute  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  hover:scale-110">
            <Image
              ...
              draggable={false}
              title="Iron Man: you can lock this by wining in 50 game in the random mode or friends mode."
            />
            <div className="w-[58px] h-[58px] absolute z-[1000]  top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="relative w-[58px] h-[58px] overflow-hidden">
                {ach7?.locked ? (
          ...
          <div className="w-full flex gap-[50px]  justify-center ">
            <div className="relative w-[97px] h-[125px] overflow-hidden   hover:scale-110 ">
              <Image
                ...
                draggable={false}
                title="Braveheart: you can lock this by wining in 5 game in the friends mode"
              />
              <div className="w-[58px] h-[58px] absolute z-[1000]  top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="relative w-[58px] h-[58px] overflow-hidden">
                  {ach4?.locked ? (
            ...
            <div className="relative w-[97px] h-[125px] overflow-hidden   hover:scale-110 mt-[73px]">
              <Image
                ...
                draggable={false}
                title="Adventurer: you can lock this by wining in 5 game in the random mode."
              />
              <div className="w-[58px] h-[58px] absolute z-[1000]  top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="relative w-[58px] h-[58px] overflow-hidden">
                  {ach3?.locked ? (
            ...
            <div className="relative w-[97px] h-[125px] overflow-hidden   hover:scale-110 ">
              <Image
                ...
                draggable={false}
                title="Defender: You can lock this by wining in 1 game in the random mode."
              />
              <div className="w-[58px] h-[58px] absolute z-[1000]  top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="relative w-[58px] h-[58px] overflow-hidden">
                  {ach2?.locked ? (

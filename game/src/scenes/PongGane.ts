...
export default class PongGane extends Phaser.Scene
{
    p1: any;
    p2: any;
    ball: any;
    ...
    update(){
        ...
        if (this.ball.body.x > 870) {
            goalscored = true;
            this.p2score++;
            this.p2goaltext.setText(this.p2score);
            this.resetGame();
        ...
        if (this.ball.body.x < 30) {
            goalscored = true;
            this.p1score++;
            this.p1goaltext.setText(this.p1score);
            this.resetGame();
    ...
    startGame() {
        this.p1victory.visible = false;
        this.p2victory.visible = false;
        const initialVelocityX = (Math.random() * 200) + 100;
        const initialVelocityY = (Math.random() * 200) + 100;

        ...
        <>
            <div className="w-full gap-10 h-full flex bg-color-18  items-center justify-center ">
                <div className="w-full h-full flex gap-[25px] flex-col items-center justify-center">
                    <div className="w-full flex xl:flex-row flex-col  gap-[25px] items-center justify-center bg-blue-500 px-10 ">
                        <ProfileCard />
                        <LeaderBoard />
                    </div>
                    <div className="w-full flex xl:flex-row flex-col  gap-[25px] items-center justify-center bg-red-300 px-10">

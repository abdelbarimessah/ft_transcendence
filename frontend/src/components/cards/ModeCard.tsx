  ...
  return (
    <>
      <div
        className={` ${
          isRandomMode ? "blur" : ""
        }  w-full max-h-full flex flex-wrap items-center justify-center gap-[24px] pb-10 pt-10 `}
      >
        <div
          className={` ${styles.playCard} cursor-pointer w-full max-w-[391px] h-[500px] rounded-[30px] overflow-hidden flex relative hover:opacity-100 `}
        >
          <Image
            src="/../../assets/2.jpg"
        ...
        <div
          className={`${styles.playCard} cursor-pointer w-full max-w-[391px] h-[500px]  rounded-[30px] overflow-hidden flex relative hover:opacity-90 `}
        >
          <Image
            src="/../../assets/3.jpg"
            alt="My Gallery Image"
                      ...
                      <li>
                        <div className="">
                          <img
                            ...
                            alt="Face"
                            className="rounded-full w-10 h-10 object-cover border-1 border-wihte"
                          ></img>
                        </div>
                      </li>
                      <li>
                        <div className="-ml-7">
                          <img
                            ...
                            alt="Face"
                            className="rounded-full w-10 h-10 object-cover border-1  border-white"
                          ></img>
                        </div>
                      </li>
                      <li>
        ...
        <div
          className={`${styles.playCard} cursor-pointer xl:mb-0 w-full max-w-[391px] h-[500px] rounded-[30px] overflow-hidden flex relative hover:opacity-90 `}
        >
          <Image
            src="/../../assets/4.jpg"
            alt="My Gallery Image"
                ...
                <div className="flex gap-[8px] items-center justify-center">
                  <div className="rounded-3xl bg-color-8 h-10 w-10 flex justify-center items-center">
                    <img
                      ...
                      className="h-6 w-6 text-white m-auto"
                      alt="Vector"
                    />
                  </div>
                  <div className="flex flex-col">
      ...
      {isRandomMode && (
        <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center z-50">
          ...
          <div
            ...
            className=" cursor-pointer w-[50px] h-[50px] bg-white fixed top-10 right-10 flex items-center justify-center z-50 rounded-[17px] "
          >

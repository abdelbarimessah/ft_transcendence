          ...
          <div className='bg-color-13 rounded-3xl h-32 mt-2 '>
            ...
            <div className=" ml-7 mt-6 flex flex-wrap">
              <div className="flex flex-wrap ">
                ...
                <div className="rounded-3xl bg-color-15 h-10 w-10 flex justify-center items-center mb-4 -ml-7">
                </div>
                <div className="rounded-3xl bg-color-14 h-10 w-10 flex justify-center items-center mb-4 -ml-7">
                </div>
              </div>
              <div className='ml-1 mt-1'>
                <p className="text-white font-poppins text-base leading-5 " >play with your</p>
              ...
              <button className={`${styles.playCardButton} font-poppins rounded-3xl capitalize bg-[#17222A] pl-6 pr-6 text-lg font-extralight text-white ml-5 mb-4 `} >play</button>
            </div>
          </div>
        </div>
      </div>

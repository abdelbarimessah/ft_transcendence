...
function EnterPassword() {
  ...
  console.log(
    "UserData.channelToJoin im at enter pass = ",
    UserData.channelToJoin
  );
  ...
  if (UserData.needPassword === true) {
    ...
    const handelChanneltoJoin = () => {
      console.log(
        "UserData.inputEnterPassRef?.current?.value = >",
        UserData.inputEnterPassRef?.current?.value
      );
      ...
      addChannelToList();
      console.log(
        "channelToJoin im at handelChanneltoJoin <= =>",
        UserData.channelToJoin.id
      );
    };

  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div onClick={toggleManual} className="absolute w-[26px] h-[26px] flex items-center justify-center -top-7 right-0 hover:scale-[1.03] cursor-pointer">
            <Image
          ...
          <div className="w-full h-full flex py-3 justify-between flex-col">
            <div className="flex items-center justify-around  gap-1">
              <button
                className={` rounded-[12px] w-[100px] h-[40px]  ${manual === 0
              ...
              <button
                className={`rounded-[12px] w-[100px] h-[40px]  ${manual === 2
                  ? "bg-color-6 text-white shadow"
                  : "bg-slate-200 text-color-31 hover:bg-slate-300"
                  }`}
                value={2}
              ...
              <button
                className={`rounded-[12px] w-[100px] h-[40px] ${manual === 1
                  ? "bg-color-6 text-white shadow"
                  : "bg-slate-200 text-color-31 hover:bg-slate-300"
                  }`}
                value={1}

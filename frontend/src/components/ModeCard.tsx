...
function ModeCard(props: any) {
    ...
    return (
        <>
            <div className='w-full min-h-full flex flex-col xl:flex-row items-center justify-center gap-[16px] mx-[20px]'>

                <div className={`${styles.playCard} w-full max-w-[391px] h-[586px]  rounded-[30px] overflow-hidden flex relative`}>
                    <Image
                        src="/../../assets/cardBackground.jpeg"
                        alt="My Gallery Image"
                        fill={true}
                        sizes="(min-width: 480px) 445px, calc(90.63vw + 28px)"
                        className='object-cover'
                        />
                    <div className='bg-color-13 w-full h-[202px] absolute bottom-0 left-0 '>
